...
impl ImGuiDockNode {
    ...
    pub fn new_bitfield_1(
        ...
        __bindgen_bitfield_unit.set(13usize, 1u8, {
            let EnableCloseButton: u8 = unsafe { ::core::mem::transmute(EnableCloseButton) };
